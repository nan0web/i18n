...
export default class I18nDb {
     ...
     * @returns {Promise<{missing: string[], unused: string[]}>}
     */
    auditTranslations(srcPath?: string | undefined): Promise<{
        missing: string[];
        unused: string[];
    }>;
    /**
    ...
    /**
     * Sync translations for all available locales
     * @returns {Promise<void>}
     */
    syncTranslationsAll(): Promise<void>;
}
